                                ...
                                <div class="portlet-body">
                                    <div class="tabbable portlet-tabs">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li id="tab_surveycollect"  class="active"><a style="cursor: pointer" data-toggle="tab"><strong>Collect</strong></a></li>
                                            <li id="tab_design"><a style="cursor: pointer"  data-toggle="tab"><strong>Design</strong></a></li>
                                        </ul>
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="collect">
												<?php
												include 'survey_collect_sub_v.php';
												?>
                                            </div>
