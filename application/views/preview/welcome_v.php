		...
		<div class="container">
			...
			<div class="row-fluid">
				<div class="span12 coming-soon-content">
					<h1><?php echo $survey[Survey_m::WELCOME_TITLE]; ?></h1>
				...
				<form name="answer_form" id="answer_form" action="<?php echo BASEURL; ?>index.php/answer/receive_answer" method="post">
					...
					<div class="row-fluid margin-bottom-20">
						<div class="offset1 row-fluid ">
							<div class="span10">
								<h4><?php echo $survey[Survey_m::WELCOME_CONTENT]; ?></h4>
							</div>
						</div>
					</div>
					<div class="row-fluid margin-bottom-20">
						<div class="row-fluid ">
							<div class="span12 offset5">
								<a href="<?php echo BASEURL . "index.php/surveyview/s/" . $survey[Survey_m::SID] ?>/1<?php echo $preview;?>" id="nextBtn" class="btn grey SurveySubmitButton"><i class="icon-ok"></i> <?php echo $this->lang->line('next'); ?></a>
							</div>
						</div>
					</div>
				</form>
